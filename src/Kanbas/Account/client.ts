...
export const USERS_API = `https://kanbas-node-server-app-m012.onrender.com/api/users`;
const axiosWithCredentials = axios.create({ withCredentials: true });
export const ENROLLMENTS_API = `https://kanbas-node-server-app-m012.onrender.com/api/enrollments`;
...
export const signin = async (credentials: any) => {
  ...
  export const findAllCourses=async()=>{
    const {data}=await axiosWithCredentials.get(`https://kanbas-node-server-app-m012.onrender.com/api/courses`);
    return data;
  }
